...
class Initialization_FanBeam:
    def __init__(self, image_size, num_proj, start_angle, proj_size, batch_size):
        '''
        ...
        ## Imaging object (reconstruction objective) with object center as         
        self.param['nx'] = image_size
        self.param['ny'] = int(image_size / batch_size)
...
class FanBeam2DProjectorLimitedAngle():
    def __init__(self, image_size, proj_size, num_proj, batch_size):
